...
****************************************************************************************
// zoekterm
// Volkskrant OR Trouw OR AD OR NRC OR Telegraaf

// Ukraine
// Expat: expat and Oekraïense and Volkskrant OR Trouw OR AD OR NRC OR Telegraaf
// Migrant:
// Vluchteling:

// Turkije:
// migrant and Turk??? and Volkskrant OR Trouw OR AD OR NRC OR Telegraaf

/// Landen <- gebaseerd op landen in conflict (Ministerie) en percentage vluchtelingen in Nederland
...
// Afghanistan (R), Irak (R), Jemen (R), Libanon (R), Libie (Download), Pakistan (Download), Sudan (R), Syrie (R)
// Somalia (Download), Eritrea (Download), Ukraine (R), Venezuela (D), Myanmar (D), Congo (D), Centraal African Replublic 

/// Maybe connect terrorist to asiekzoeker
**************************************************
...
note("Source: President Jeff", span)
